export const SITE = {
  ...
  linkedin: "https://www.linkedin.com/in/bidyapathi-ray",
};
...
export const OTHER_WORK = {
  additionalCaseStudies: [
    { id: "swrc-super5", title: "Super5 Nutrition Enterprise", subtitle: "SWRC / Barefoot College", metric: "52X production scale · 20K+ lives", tag: "0→1 Social Enterprise", description: "Built a nutrition delivery enterprise from scratch in rural Rajasthan — standardized formulation, hub-and-spoke distribution across 453 villages, 180 women entrepreneurs, biometric consumption monitoring. Revenue CAGR 176%." },
    { id: "aem-integration", title: "Enterprise DAM Integration", subtitle: "DaVinci Commerce", metric: "$2M annual savings", description: "Bidirectional integration with Adobe Experience Manager for a Fortune 500 retailer — eliminating ~30K manual uploads/year and preserving asset lineage via configurable writeback logic.", tag: "Enterprise Platform" },
  ],
  sideProjectsComingSoon: true,
  sideProjects: [
